...
float32_t  audio_delay_buffer   [AUDIO_DELAY_BUFSIZE];  //SP9BSL
...
__IO AudioDriverState   ads;        //SP9BSL
AudioDriverBuffer       adb;        //SP9BSL
LMSData                 lmsData;    //SP9BSL
