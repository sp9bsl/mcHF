...
#define POS_FREEDV_MSG_X 170
#define POS_FREEDV_MSG_Y 278
#define POS_FREEDV_BER_X 85
#define POS_FREEDV_BER_Y POS_FREEDV_MSG_Y
#define POS_FREEDV_SNR_X 0
#define POS_FREEDV_SNR_Y POS_FREEDV_MSG_Y

void fdv_clear_display()
{ char clr_string[freedv_rx_buffer_max];

  snprintf(clr_string,freedv_rx_buffer_max,"                                                                           ");
  UiLcdHy28_PrintText(POS_FREEDV_SNR_X,POS_FREEDV_SNR_Y,"            ",Yellow,Black,4);
  UiLcdHy28_PrintText(POS_FREEDV_BER_X,POS_FREEDV_BER_Y,"            ",Yellow,Black,4);
  UiLcdHy28_PrintText(POS_FREEDV_MSG_X,POS_FREEDV_MSG_Y,clr_string,Yellow,Black,4);
}
...
void fdv_print_txt_msg()
{
  ...
  UiLcdHy28_PrintText(POS_FREEDV_MSG_X,POS_FREEDV_MSG_Y,txt_out,Yellow,Black,4);
...
void fdv_print_ber()
{
  ...
  UiLcdHy28_PrintText(POS_FREEDV_BER_X,POS_FREEDV_BER_Y,ber_string,Yellow,Black,4);
...
void fdv_print_SNR()
{
  ...
  UiLcdHy28_PrintText(POS_FREEDV_SNR_X,POS_FREEDV_SNR_Y,SNR_string,Yellow,Black,4);
